...
const TransitionComponent = ({ children }) => {
  ...
  useEffect(() => {
    ...
    if (location.pathname === "/about" || location.pathname === "/services" || location.pathname === "/contact") {
    ...
    <SwitchTransition>
      <Transition
        ...
        onEnter={() => {
          ...
          let requireDarkRoom = false;
          if (
            location.pathname === "/about"  || location.pathname === "/services"|| location.pathname === "/contact"
          ) {
            requireDarkRoom = true;
          }
